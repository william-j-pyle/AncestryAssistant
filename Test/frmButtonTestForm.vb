...
Public Class frmButtonTestForm
  ...
  Private Sub LoadIcons(key As String)
    ...
    Select Case key
      Case "RS"
        ...
        Dim iconFont As System.Drawing.Font = New System.Drawing.Font("Segoe Fluent Icons", iconSize, FontStyle.Regular, System.Drawing.GraphicsUnit.Pixel, CType(0, Byte))
      ...
      Case "RA"
        ...
        Dim iconFont As System.Drawing.Font = New System.Drawing.Font("ancestry-icon", iconSize, FontStyle.Regular, System.Drawing.GraphicsUnit.Pixel, CType(0, Byte))
        ' Print out names and values
  ...
  Private Sub btnExportStyle_Click(senderAsObject, eAsEventArgs) Handles btnExportStyle.Click
