...
#Region "Properties"
  ...
  Public Property ImageCancelSearch As Image = My.Theme.ColorIcon(My.Resources.ANCESTRY_FAMILY_VIEW, My.Theme.PanelFontColor)

  Public Property ImageDropDown As Image = My.Theme.ColorIcon(My.Resources.ANCESTRY_FAN_VIEW, My.Theme.PanelFontColor)

  Public Property ImageSearch As Image = My.Theme.ColorIcon(My.Resources.ANCESTRY_PEDIGREE_VIEW, My.Theme.PanelFontColor)
