Public Class ToolStripRenderer
  ...
  Public Sub New()
    ...
    Private Sub ToolStripRenderer_RenderSeparator(sender As Object, e As ToolStripSeparatorRenderEventArgs) Handles Me.RenderSeparator
        ...
        End Using
        Using pen As Pen = New Pen(COLOR_SELECTED_BORDER, 1)
            e.Graphics.DrawLine(pen, e.Item.ContentRectangle.X, e.Item.ContentRectangle.Top, e.Item.ContentRectangle.X, e.Item.ContentRectangle.Bottom)
        End Using
    End Sub
    ...
    Private Sub ToolStripRenderer_RenderButtonBackground(sender As Object, e As ToolStripItemRenderEventArgs) Handles Me.RenderButtonBackground
