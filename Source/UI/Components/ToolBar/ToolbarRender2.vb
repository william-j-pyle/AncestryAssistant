Public Class ToolbarRenderer2
  ...
  Private Function GetButtonColor(state As ButtonState) As Color
    Select Case state
      Case ButtonState.Normal
        Return theme.AppToolbarButtonColor
      Case ButtonState.Hover
        Return theme.AppToolbarButtonHoverColor
      Case ButtonState.Pressed
        Return theme.AppToolbarButtonPressedColor
      Case ButtonState.Disabled
        Return theme.AppToolbarButtonColor
      Case Else
        Return theme.AppToolbarBackColor
    End Select
  End Function
  ...
  Private Sub ToolbarRenderer2_RenderToolStripBackground(sender As Object, e As ToolStripRenderEventArgs) Handles Me.RenderToolStripBackground
    Using brush As New SolidBrush(theme.AppToolbarBackColor)
