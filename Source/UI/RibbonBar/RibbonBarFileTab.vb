...
#Region "Public Constructors"
  ...
  Public Sub New()
    InitializeComponent()
    items = New Dictionary(Of String, BordersPanel)
  ...
  Private Sub trackButton(key As String, ctl() As Control)
    For Each c As Control In ctl
      If TypeOf c Is Label Then
        ...
        End With
      End If
      If TypeOf c Is BordersPanel Then
        With CType(c, BordersPanel)
          .Tag = key
          .Cursor = Cursors.Hand
          .BackColor = My.Theme.AppBackColor
          .Font = My.Theme.AppFont
          ...
          AddHandler .MouseLeave, AddressOf Button_MouseLeave
        End With
        items.Add(key, CType(c, BordersPanel))
      End If
    Next
  End Sub
...
#Region "Fields"
  ...
  Private items As Dictionary(Of String, BordersPanel)
