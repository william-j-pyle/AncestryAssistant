Public Class DockPanelManager
  ...
  Public Sub New()
    ...
    'pnlMiddleRight
    '
    pnlMiddleRight.BackColor = theme.PanelBackColor
    ...
    'pnlMiddleBottom
    '
    pnlMiddleBottom.BackColor = theme.PanelBackColor
    ...
    'pnlLeftBottom
    '
    pnlLeftBottom.BackColor = theme.PanelBackColor
    ...
    'DockLeftBottom
    '
    DockLeftBottom.BackColor = theme.PanelBackColor
    ...
    'pnlLeftTop
    '
    pnlLeftTop.BackColor = theme.PanelBackColor
    ...
    'pnlRightBottom
    '
    pnlRightBottom.BackColor = theme.PanelBackColor
    ...
    'pnlRightTop
    '
    pnlRightTop.BackColor = theme.PanelBackColor
