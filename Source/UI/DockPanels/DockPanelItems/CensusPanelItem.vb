...
#Region "Properties"
  ...
  Public ReadOnly Property ItemCaption As String = UNIFIED_TEXT Implements IDockPanelItem.ItemCaption
...
#Region "Public Constructors"
  ...
  Public Sub New()
    ...
    'ts
    '
    ts.BackColor = My.Theme.PanelBorderColor
    ts.ForeColor = My.Theme.PanelFontColor
