...
#Region "Public Constructors"
  ...
  Public Sub New()
    pnlMain = New AncestryAssistant.BordersPanel()
    pnlSearch = New AncestryAssistant.BordersPanel()
    txtSearch = New System.Windows.Forms.TextBox()
    pnlButtonContainerSearch = New System.Windows.Forms.TableLayoutPanel()
    btnSearch = New AncestryAssistant.IconButton()
    pnlHeader = New AncestryAssistant.BordersPanel()
...
#Region "Fields"
  ...
  Private WithEvents pnlHeader As BordersPanel
  Private WithEvents pnlMain As BordersPanel
  Private WithEvents pnlSearch As BordersPanel
