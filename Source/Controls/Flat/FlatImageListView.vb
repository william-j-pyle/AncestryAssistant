...
Public Class FlatImageListView
  Inherits ListView
  ...
  Public Sub New()
    ...
    ImgViewerList = New ImageList(components) With {
  ...
  Private Sub AddImageToGallery(path As String, fileName As String)
    ...
    Else
      caption = fileName.Replace(path, "").Replace(".jpg", "")
    End If
    ...
    Debug.Print("Added Image To Gallery")
    ImgViewerList.Images.Add(key, Img)
    Dim newItem As ListViewItem = Items.Add(caption, key)
  ...
  Public Sub LoadImageAsync(path As String, fileName As String)
    Debug.Print("LoadImageAsync({0})", fileName)
