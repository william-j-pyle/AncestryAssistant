...
Public Class DPIImageGalleryWeb
  ...
  Public Const Base_Key As String = "DOCK_IMAGEGALLERY"
  ...
  Private Sub ActiveAncestorChanged() Handles _Ancestors.ActiveAncestorChanged
    UpdateData()
  End Sub
